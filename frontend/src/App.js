...
function MainApp() {
  ...
  // Category management functions (defined early to avoid initialization issues)
  ...
  // Load categories when categories tab is accessed
  useEffect(() => {
...
// Old CategoriesManager component removed - now using CategoryManager from separate file
